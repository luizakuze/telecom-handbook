...
setup:
    ...
    ldi AUX, 0x02 ; Configura INT0 para borda de descida (reset)
    sts EICRA, AUX
    ldi AUX, 0x08 ; Configura INT1 para borda de descida (pausa)
    sts EICRA+1, AUX
    ldi AUX, 0x01
    ori AUX, 0x02 ; Habilita interrupções externas INT0 e INT1
    out EIMSK, AUX
