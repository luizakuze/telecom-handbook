@ Conta quantas vezes um botão externo foi pressionado.
@ Mostra a contagem nos LEDs.
...
main:
    ...
    sbic PIND, BOTAO_CONTAR  ; Se não pressionado, pula a próxima instrução
    inc CONTADOR             ; Se pressionado, incrementa o contador
