...
DDRx: registrador de direção, usado para definir se os pinos de Px são entrada ou
saída.


PORTx: registrador de dados, usado para modificar os pinos de Px, quando
configurados como saída, e habilitar o pull-up, quando configurados como entrada.
...
test_sequence:
    ...
    ; Simula ajuste pressionado (PB0 = 1)
    ldi r16, 0x01       ; PB0 em nível alto
    out PINB, r16       ; Simula leitura do botão
    rcall ajuste_pressed

    ; Simula seleção pressionado (PB1 = 1)
    ldi r16, 0x02       ; PB1 em nível alto
    out PINB, r16       ; Simula leitura do botão
    rcall selecao_pressed
