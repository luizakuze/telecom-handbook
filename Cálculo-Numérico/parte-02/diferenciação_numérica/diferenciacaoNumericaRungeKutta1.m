...
F = @(x) exp(x); % Função exata para comparação
...
for i = 1:L/h
    k1 = y0;                         % Calcula o valor de k1
    k2 = y0 + h * k1 / 2;            % Calcula o valor de k2
    k3 = y0 + h * k2 / 2;            % Calcula o valor de k3
    k4 = y0 + h * k3;                % Calcula o valor de k4
...
title('Método de Runge-Kutta de 4ª Ordem'); % Título do gráfico
